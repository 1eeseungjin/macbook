...
class InstaUnfollowers:
    def __init__(self, username, password):
        ...
        sleep(2)
        # instagram login
        username_type = self.driver.find_element_by_xpath(
            "/html/body/div[1]/section/main/article/div[2]/div[1]/div/form/div/div[1]/div/label/input")
        username_type.send_keys(username)
        password_type = self.driver.find_element_by_xpath(
    ...
    def get_people(self, k):
        sleep(2)
        scroll_box = self.driver.find_element_by_xpath("/html/body/div[6]/div/div/div[" + k + "]")
    ...
    def get_unfollowers(self):
        ...
        from creditentials import username
