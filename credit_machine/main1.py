all_credit = int(input("총 이수학점을 말해봐:")) #177
pass_credit = int(input("패스 이수학점을 말해봐:")) #28
all_credit = all_credit - pass_credit
score = float(input("졸업평점을 말해봐:")) #3.36
...
print("이수학점:",new_credit+pass_credit,"\n졸업평점:",round(new_score,3))
cnt = 0
jae = 0
while 1:
    ...
    if retaking == '0':
        ...
        print("*총 다시듣는 학점::",repeat*jae+add_credit,"학점")
